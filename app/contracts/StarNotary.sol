...
contract StarNotary is ERC721 {
    ...
    modifier isOwner(address senderAddress){
        require(senderAddress==msg.sender);
            _; 
            }
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        string memory sttarName = tokenIdToStarInfo[_tokenId].name;
        return sttarName;
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) isOwner(msg.sender) public {
